...
urlpatterns = [
    ...
    # 공고 상세 조회, 수정, 삭제
    path("<uuid:job_posting_id>/", JobPostingDetailView.as_view(), name="job_posting_detail"),
    ...
    # 북마크 등록/삭제
    path("bookmark/<uuid:job_posting_id>/", JobPostingBookmarkView.as_view(), name="bookmark_toggle"),
]